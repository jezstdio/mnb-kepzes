  ...
  return (
    <div className="text-center padding-y-64 padding-x-24 max_width-512px margin-x-auto">
      ...
      <button
        ...
        onClick={() => props.handleLinks("penzugyi-piacok", "Quiz")}
      >Pénzügyi piacok</button>
      <button
        className="block underline padding-y-16"
        onClick={() => props.handleLinks("altalanos-jogi-ismeretek", "Quiz")}
      ...
      <button
        className="block underline padding-y-16"
        onClick={() => props.handleLinks("hitelezesi-alapfogalmak", "Quiz")}
      >Hitelezési alapfogalmak</button>
      <button
        className="block underline padding-y-16"
        onClick={() => props.handleLinks("hiteltipusok-es-hiteltermekek", "Quiz")}
      >Hiteltípusok és hiteltermékek</button>
      <button
        className="block underline padding-y-16"
        onClick={() => props.handleLinks("a-mikro-kis-es-kozepvallalati-uzletag-fobb-termekei-es-szolgaltatasai", "Quiz")}
